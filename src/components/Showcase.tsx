...
const sections = [
  {
    label: "01 — Master Fleet",
    title: "Lamborghini\nUrus SE",
    desc: "A centerpiece of our automotive collection. Unrivaled presence meets the versatilty required for the Miami lifestyle.",
    tags: ["Latouche Select", "Hybrid Performance", "Bespoke"],
    color: "#050505",
    accent: "#C5A47E"
  },
  {
    label: "02 — Coastal Luxury",
    title: "BMW\nM4 Competition",
    desc: "Engineered for precision. The perfect companion for navigating the scenic routes of the Florida coastline.",
    tags: ["Grand Tourer", "Isle of Man Green", "Signature"],
    color: "#050505",
    accent: "#C5A47E"
  },
  {
    label: "03 — Pure Distinction",
    title: "McLaren\n570S Coupe",
    desc: "An icon of performance and style. Curated for those who demand absolute distinction in every journey.",
    tags: ["Carbon Series", "Black Collection", "Elite"],
    color: "#050505",
    accent: "#C5A47E"
  }
];
