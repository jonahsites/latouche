    ...
    >
      <div className="max-w-[1400px] mx-auto">
        ...
        <div className="flex justify-between items-start mb-20">
          <div>
            <div className="text-accent text-[10px] uppercase tracking-[0.5em] font-bold mb-4">The Concierge Portfolio by Latouche Hospitality</div>
            <h2 className="text-5xl md:text-7xl font-serif font-bold uppercase tracking-tighter leading-none">
              The <span className="text-white/20 text-outline">Latouche</span> <br/> Experience.
            </h2>
          </div>
          <button 
            onClick={onClose}
